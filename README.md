...
This is an implementation code for <a href="">Convolution Based Spectral Partitioning Architecture for Hyperspectral Image Classification</a>
...
<img src="http://www.doc.ic.ac.uk/~swc3918/img/arch8.png" width="90%"><br>

This is a new neural network architecture using 3D Convolutional neural network with partitioning on \lamba dimension to classify unlabelled pixel on Hyperspectral images,
 and achieve the state-of-art performance on classification with labelled dataset on Indian Pines, Salinas scenes.
...
- **Acquire the Dataset (Do this Step if you're on Windows)**
...
- **Train the model**
    - Run the following command: `python conv3d_segment.py --data Indian_pines --epochs 650`
    - --data : Choose from Indian Pines, Salinas, KSC or Botswana
